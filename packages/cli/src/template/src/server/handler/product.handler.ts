...
export const updateProduct = (params: Record<string, string>, body: ProductRequest.Update) => {
  const id = parseInt(params.id);
...
export const createProductProgress = (params: Record<string, string>, body: ProgressRequest.Create) => {
  const productId = parseInt(params.id);
...
export const updateProgressDetail = (params: Record<string, string>, body: ProgressRequest.Update) => {
  const productId = parseInt(params.id);
  const progressId = parseInt(params.progressId);
