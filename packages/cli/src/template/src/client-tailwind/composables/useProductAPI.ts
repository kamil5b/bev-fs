...
export function useProductAPI() {
  ...
  const getProgress = async (productId: number, progressId: number): Promise<ProgressResponse.GetById | ErrorResponse> => {
    try {
  ...
  const createProgress = async (productId: number, data: ProgressRequest.Create): Promise<ProgressResponse.Create | ErrorResponse> => {
    try {
      const res = await fetch(`${BASE_URL}/product/${productId}/progress`, {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
  ...
  const updateProgress = async (productId: number, progressId: number, data: ProgressRequest.Update): Promise<ProgressResponse.Update | ErrorResponse> => {
    try {
      const res = await fetch(`${BASE_URL}/product/${productId}/progress/${progressId}`, {
        method: 'PATCH',
        headers: { 'Content-Type': 'application/json' },
  ...
  const deleteProgress = async (productId: number, progressId: number): Promise<ProgressResponse.Delete | ErrorResponse> => {
    try {
      const res = await fetch(`${BASE_URL}/product/${productId}/progress/${progressId}`, {
        method: 'DELETE'
      });
